...
testing_dataset_df = pd.read_csv("pure_antibody_fasta_modified.csv")
...
for index, row in testing_dataset_df.iterrows():
    ...
    igfold.fold(
        os.path.join(".", "pure_fasta_results", output_file_name), # Output PDB file
    ...
    cur_tmscore, cur_rmsd = compare_proteins(os.path.join(".", "pure_fasta_results", output_file_name),
    ...
    igfold.fold(
        os.path.join(".", "pure_fasta_results", output_file_name_light), # Output PDB file
    ...
    cur_tmscore_short, cur_rmsd_short = compare_proteins(os.path.join(".", "pure_fasta_results", output_file_name_light),
                                                         os.path.join(".", "actual_pdb_structures", pure_name + ".pdb"))
...
results_df.to_csv("pure_testing_results.csv")