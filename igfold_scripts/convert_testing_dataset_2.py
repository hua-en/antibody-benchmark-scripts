...
for fasta_file in os.listdir("."):
    for record in SeqIO.parse(fasta_file, "fasta"):
        ...
        try:
            ...
            new_fasta_file_path = os.path.join("..", "pure_antibody_train_shortened", record.id.split("|")[0] + "-short.fasta")
...
os.chdir("..")
os.chdir("pure_antibody_train_shortened")
...
fasta_df.to_csv("pure_antibody_fasta.csv")